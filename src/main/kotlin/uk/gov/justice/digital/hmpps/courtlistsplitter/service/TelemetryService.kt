...
class TelemetryService(private val telemetryClient: TelemetryClient) {
  ...
  fun trackListEvent(messageId: String) {
    val properties = mapOf(SQS_MESSAGE_ID_KEY to messageId)
    telemetryClient.trackEvent(TelemetryEventType.COURT_LIST_MESSAGE_RECEIVED.eventName, properties, emptyMap())
  }
  ...
  fun trackCourtCaseEvent(case: Case, messageId: String) {
    ...
    telemetryClient.trackEvent(TelemetryEventType.COURT_CASE_RECEIVED.eventName, properties, emptyMap())
  }
